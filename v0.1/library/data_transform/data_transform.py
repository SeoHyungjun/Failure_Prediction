...
class data_transform:
    ...
    def sel_cols_by_index(self, data, cols_index):
        """
        cols_index is integer or list of integer.
        """
    ...
    def sel_cols_by_name(self, data, cols_name):
        """
        cols_name is string or list of string.
        """
    ...
    def split_xy_by_yindex(self, data, y_cols):
    ...
    def make_node_y_input(self, y_bundle, num_y_type):
        """
    ...
    def divide_fold(self, x, y, num_fold):
        """
